...
menuBtn.addEventListener("click", () => {
  ...
  if (isOpen) {
    ...
    mobileMenu.classList.add("closed", "opacity-0", "scale-95");
    setTimeout(() => {
      mobileMenu.classList.add("hidden");
    }, 200);
  } else {
    // Abrir
    mobileMenu.classList.remove("hidden", "closed");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const images = {
    ...
    reforma4: [
      "img/portifolio/imgPiso1.jpg",
      "img/portifolio/imgPiso2.jpg",
      "img/portifolio/imgPiso3.jpg",
      "img/portifolio/imgPiso4.jpg",
      "img/portifolio/imgPiso5.jpg",
    ],
    reforma5: [
      "img/portifolio/imgBanheiroPia2.jpg",
      "img/portifolio/imgBanheiroPia1.jpg",
    ],

    reforma6: ["img/portifolio/imgSala.jpg", "img/portifolio/imgSala2.jpg"],
  };
